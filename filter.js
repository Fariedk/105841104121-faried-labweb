...
import { Text, View, TouchableOpacity, PanResponder,ScrollView, Animated } from 'react-native';
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: '#FFFFFF', padding: 16 }}>
      ...
      <TouchableOpacity style={{ paddingVertical: 15, paddingHorizontal: 20, borderBottomWidth: 1, borderBottomColor: '#f0f0f0' }}>
        ...
        <Text style={{ fontSize: 14, color: 'gray', marginTop: 5 }}>adidas Originals, Jack & Jones, s.Oliver</Text>
      </TouchableOpacity>
      <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center'}}>
        <TouchableOpacity style={{ width: 80,height:40, backgroundColor: 'white', borderColor: 'black', borderWidth:1, borderRadius: 15 }} onPress={discardFilters}>
          <Text style={{ fontSize: 16, fontWeight: 'bold',textAlign: 'center', color: '#000000' }}>Discard</Text>
        </TouchableOpacity>
        <TouchableOpacity style={{ width: 80, height: 40, backgroundColor: '#B82222', borderRadius: 15, marginLeft: 20 }} onPress={applyFilters}>
          <Text style={{ fontSize: 16, fontWeight: 'bold', textAlign: 'center', color: '#FFFFFF' }}>Apply</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
